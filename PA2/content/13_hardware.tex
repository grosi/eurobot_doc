...
\chapter{Hardware}\label{ch:hardware_pa2}
	...
	\section{Bedieneinheit}\label{s:hw_bedieneinheit}
		...
		Das \gls{ac:kernteam} hat daher beschlossen eine einfache Bedieneinheit mit einem kleinem LC-Display (2x16) und mehreren Tastern zu entwickeln (Abbildung \ref{pic:bedienpanel}). Diese Aufgabe fiel dem \gls{ac:kernteam}-Mitglied Jascha zu und stellt damit der Hauptbestandteil seiner \gls{ac:pa2} dar.
		\par
		...
		\subsection{Displayauswahl}\label{ss:displayaswahl}
	        ...
	        \end{itemize}
			Daraus ergaben sich vier LC-Displays, die diese Anforderungen erfüllen.\\
		...
		\subsection{Layout}\label{ss:layout}
			...
			Die Prints für beide Roboter wurden intern (mit der Fräse) innerhalb eines Tages hergestellt.
			%
