...
\chapter{Zeichnungen CAD}\label{ch:zeichnungen_cad}
	...
	\section{\gls{g:mammut}}
		...
		\section{\gls{g:mammut_catch}}
			...
			\begin{itemize}[parsep=1pt]
				\item Netzwurfmechanismus
				\item Explosionszeichnung Netzwurfmechanismus 1 \& 2
				\item Abschussblech
				\item Netzblech 
				\item Zwischenstück
				\item Nase
				\item Führungsblock
				\item Befestigungsplättli
				\item Lagerbock
				\item Befestigungsstück
				\item Auslösestab
				\item Stabhalterung
				\item Befestigung Servo
				\item Aufhängung Netzblech
				\item Plättli Aufhängung
				\item Profilbefestigung
				\item Auflage Netzblech
				\item Seitenblech 
				\item Verbindung Seitenblech klein
				\item Verbindung Seitenblech gross
			\end{itemize}
				%
			\section{\gls{g:fire}}
				Für die \gls{g:fire}-Aufgabe wurden folgende Teile entworfen.
				\begin{itemize}[parsep=1pt]
					\item Baugruppe Feuer
					\item Explosionszeichnung Baugruppe Feuer
					\item Saugeraufnahme
					\item Servohebel rechts
					\item Servohebel links
					\item Servowelle
					\item Servo Lagerbock
					\item Winkelaufnahme
					\item Schutzklinke
					\item Führungsaufnahme
					\item Saugerabdeckung
					\item Tasteraufnahme
				\end{itemize}
			\section{\"Anderungen}
				...
				\begin{itemize}[parsep=1pt]
					...
					\item Lagerbock Federspanner links
					\item Bügel Servo
					\item Gabelhebel Servo
					\item Steg
					\item Zuführrohr links
					\item Zuführrohr rechts
					\item Vereinzler Platte
					\item Vereinzler Distanzhalter
					\item Radkappe
					\item Distanzscheibe 
					\item Distanzscheibe Drehgeber
				\end{itemize}
		%
		%
		%Fresko
